...
**Tag:** `v2.1-failsafe-dialplan-fixed`  
**Commit:** `2bb3d54`  
**Status:** ✅ Working - Fixed dialplan routing, all media through Asterisk
...
git fetch --all --tags
git reset --hard v2.1-failsafe-dialplan-fixed
...
cd webrtc-genesys
git checkout v2.1-failsafe-dialplan-fixed
